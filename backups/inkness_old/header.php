...
<div style="color: skyblue">
	<?php if(is_user_logged_in()) { ?>
		<a href="<?php echo get_site_url(); ?>/?page_id=193" style="color: skyblue">Edit Profile</a> 
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="<?php echo wp_logout_url(); ?>" style="color: skyblue">Logout</a>
	<?php } else { ?>
		<a href="<?php echo get_site_url(); ?>/login-3/" data-toggle="modal" style="color: skyblue">Login</a> 
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="<?php echo get_site_url(); ?>/register/" style="color: skyblue">Register</a>
	<?php } ?>
</div>
	...
	<div id="header-2">
		...
		<div id="top-search" class="col-md-4 col-xs-12" style="z-index:0;">
			<?php get_search_form(); ?>
		</div>
		</div>
	</div>
